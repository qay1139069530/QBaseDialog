...
public class DialogPopupHomeActivity extends AppCompatActivity {
    private Context mContext = this;
    private final String[] mItems = {"Custom Popup", "BubbleInterPopupQ"};
    private final Class<?>[] mClazzs = {DialogCustomPopupActivity.class, DialogBubblePopupActivity.class};
