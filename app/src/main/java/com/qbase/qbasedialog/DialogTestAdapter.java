...
public class DialogTestAdapter extends BaseAdapter {
	private Context mContext;
	private ArrayList<QBaseDialogMenuItem> mMenuItems;
	private DisplayMetrics mDisplayMetrics;

	public DialogTestAdapter(Context context, ArrayList<QBaseDialogMenuItem> customBaseItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		final QBaseDialogMenuItem item = mMenuItems.get(position);
