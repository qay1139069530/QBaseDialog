...
public class DialogNormalList extends QBaseDialog<DialogNormalList> {
    /** ListView */
    ...
    private OnItemClick mOnOperItemClickL;
    private LayoutAnimationController mLac;

    public void setOnOperItemClickL(OnItemClick onOperItemClickL) {
        mOnOperItemClickL = onOperItemClickL;
    }

    public DialogNormalList(Context context, ArrayList<QBaseDialogMenuItem> baseItems) {
        super(context);
        mContents.addAll(baseItems);
        init();
    }

    public DialogNormalList(Context context, String[] items) {
        super(context);
    ...
    public DialogNormalList(Context context, BaseAdapter adapter) {
        super(context);
        mAdapter = adapter;
        init();
    }
    ...
    /** set title background color(设置标题栏背景色) @return DialogNormalList */
    public DialogNormalList titleBgColor(int titleBgColor) {
        mTitleBgColor = titleBgColor;
        return this;
    }

    /** set title text(设置标题内容) */
    public DialogNormalList title(String title) {
        mTitle = title;
        return this;
    }

    /** set title textsize(设置标题字体大小) */
    public DialogNormalList titleTextSize_SP(float titleTextSize_SP) {
        mTitleTextSize = titleTextSize_SP;
        return this;
    }

    /** set title textcolor(设置标题字体颜色) */
    public DialogNormalList titleTextColor(int titleTextColor) {
        mTitleTextColor = titleTextColor;
        return this;
    }

    /*** enable title show(设置标题是否显示) */
    public DialogNormalList isTitleShow(boolean isTitleShow) {
        mIsTitleShow = isTitleShow;
        return this;
    }

    /** set ListView background color(设置ListView背景) */
    public DialogNormalList lvBgColor(int lvBgColor) {
        mLvBgColor = lvBgColor;
        return this;
    }

    /** set corner radius(设置圆角程度,单位dp) */
    public DialogNormalList cornerRadius(float cornerRadius_DP) {
        mCornerRadius = cornerRadius_DP;
        return this;
    }

    /** set divider color(ListView divider颜色) */
    public DialogNormalList dividerColor(int dividerColor) {
        mDividerColor = dividerColor;
        return this;
    }

    /** set divider height(ListView divider高度) */
    public DialogNormalList dividerHeight(float dividerHeight_DP) {
        mDividerHeight = dividerHeight_DP;
        return this;
    }

    /** set item press color(item按住颜色) */
    public DialogNormalList itemPressColor(int itemPressColor) {
        mItemPressColor = itemPressColor;
        return this;
    }

    /** set item textcolor(item字体颜色) */
    public DialogNormalList itemTextColor(int itemTextColor) {
        mItemTextColor = itemTextColor;
        return this;
    }

    /** set item textsize(item字体大小) */
    public DialogNormalList itemTextSize(float itemTextSize_SP) {
        mItemTextSize = itemTextSize_SP;
        return this;
    }

    /** set item height(item高度) */
    public DialogNormalList setItemExtraPadding(int itemLeft, int itemTop, int itemRight, int itemBottom) {
    ...
    public DialogNormalList layoutAnimation(LayoutAnimationController lac) {
        mLac = lac;
        return this;
    }
