...
public abstract class QBaseTopDialog<T extends QBaseTopDialog<T>> extends QBaseBottomDialog<T> {
    public QBaseTopDialog(Context context, View animateView) {
        super(context);
    ...
    public QBaseTopDialog(Context context) {
        this(context, null);
    }
